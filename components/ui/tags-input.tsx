    ...
    return (
      ...
      >
        <div
          ...
          dir={dir}
          className={cn(
            "flex w-full items-center flex-wrap gap-1 p-1 rounded-md border border-input bg-background overflow-hidden focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1  ",
            {
        ...
        >
          {value.map((item, index) => (
            <Badge
              ...
              className={cn(
                "relative px-1 rounded flex items-center gap-1 data-[active='true']:ring-1 data-[active='true']:ring-muted-foreground truncate aria-disabled:opacity-50 aria-disabled:cursor-not-allowed",
              )}
              variant={"secondary"}
            >
